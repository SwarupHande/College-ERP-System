...
import { saveFeeReceiptToDBAction } from '../../redux/usersSlice';
...
const StudentRecord = () => {
  ...
  const handleSaveToDatabase = () => {
    setLoading(true);
    dispatch(saveFeeReceiptToDBAction(data))
      .then((res) => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="relative pb-10 mx-20">
